...
This role deploys and manages Simple App for the homelab environment. It provides modular tasks for deployment, validation, monitoring, backup, security, and homepage integration.

## Features
- Deploy and configure Simple App
...
- Automated validation and health scripts for Simple App
