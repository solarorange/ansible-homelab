#!/usr/bin/env python3
"""
Service Discovery Script for Sonarr
Automatically discovers and configures sonarr service
"""
...
class SonarrDiscovery:
    ...
    def discover_service(self) -> Dict[str, Any]:
        """Discover sonarr service configuration"""
        try:
            # Health check
...
if __name__ == "__main__":
    # Example usage
    discovery = SonarrDiscovery("{{ ansible_default_ipv4.address }}", 8080)
